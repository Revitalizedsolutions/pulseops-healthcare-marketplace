...
export function GoogleAuthButton({ onClick, disabled, userType, mode = 'signin' }: GoogleAuthButtonProps) {
  const getUserTypeLabel = () => {
    switch (userType) {
      case 'nurse': return 'Nurse';
      case 'hco': return 'Healthcare Organization';
    ...
    >
      {disabled ? (
        ...
        <>
          ...
          {mode === 'signin' ? 'Sign in' : 'Sign up'} with Google as {getUserTypeLabel()}
        </>
      )}
    </button>
  );
